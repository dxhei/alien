...
if ( ! class_exists( 'JNews_Migration_Newspaper_Shortcode' ) ) {
	class JNews_Migration_Newspaper_Shortcode {
		/**
		 * @var JNews_Migration_Newspaper_Shortcode
		 */
		...
		/**
		 * @return JNews_Migration_Newspaper_Shortcode
		 */
		...
		/**
		 * JNews_Migration_Newspaper_Shortcode constructor
		 */
		...
		public function load_assets() {
			wp_enqueue_style( 'jnews-migration-newspaper-style', JNEWS_MIGRATION_NEWSPAPER_URL . '/assets/css/shortcode.css', null, JNEWS_MIGRATION_NEWSPAPER_VERSION );
