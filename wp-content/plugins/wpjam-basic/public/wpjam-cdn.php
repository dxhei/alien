	...
	public static function get_sections(){
		...
		$image_fields	= [
			...
			'watermark_set'	=> ['title'=>'水印设置',		'type'=>'fieldset',	'show_if'=>self::get_show_if('!=','volc_imagex'),	'fields'=>[
				...
				'width'		=> ['title'=>'最小尺寸：',	'type'=>'number',	'group'=>'size',		'name'=>'watermark_width',	'class'=>'small-text'],
				'view'		=> ['title'=>'',			'type'=>'view',		'group'=>'size',		'value'=>'<span class="dashicons dashicons-no-alt"></span>'],
				'height'	=> ['title'=>'',			'type'=>'number',	'group'=>'size',		'name'=>'watermark_height',	'class'=>'small-text',	'description'=>'小于该尺寸的图片都不会加上水印，仅支持阿里云OSS和腾讯云COS'],
			]],
