...
if ( ! class_exists( 'JNews_Migration_Sahifa_Shortcode' ) ) {
	class JNews_Migration_Sahifa_Shortcode {

		/**
		 * @var JNews_Migration_Sahifa_Shortcode
		 */
		...
		/**
		 * @return JNews_Migration_Sahifa_Shortcode
		 */
		...
		/**
		 * JNews_Migration_Sahifa_Shortcode constructor
		 */
		...
		public function load_assets() {
			wp_enqueue_style( 'jnews-migration-sahifa-style', JNEWS_MIGRATION_SAHIFA_URL . '/assets/css/shortcode.css', null, JNEWS_MIGRATION_SAHIFA_VERSION );
			wp_enqueue_style( 'jnews-migration-sahifa-skin', JNEWS_MIGRATION_SAHIFA_URL . '/assets/css/ilightbox/' . $this->options['lightbox_skin'] . '-skin/skin.css', null, JNEWS_MIGRATION_SAHIFA_VERSION );

			wp_enqueue_script( 'jnews-migration-sahifa-tipsy', JNEWS_MIGRATION_SAHIFA_URL . '/assets/js/vendor/tipsy.min.js', array( 'jquery' ), JNEWS_MIGRATION_SAHIFA_VERSION );
			wp_enqueue_script( 'jnews-migration-sahifa-lightbox', JNEWS_MIGRATION_SAHIFA_URL . '/assets/js/vendor/ilightbox.packed.js', array( 'jquery' ), JNEWS_MIGRATION_SAHIFA_VERSION );

			wp_register_script( 'jnews-migration-sahifa-tabs', JNEWS_MIGRATION_SAHIFA_URL . '/assets/js/vendor/tabs.min.js', array( 'jquery' ), JNEWS_MIGRATION_SAHIFA_VERSION );
			wp_register_script( 'jnews-migration-sahifa-cycle', JNEWS_MIGRATION_SAHIFA_URL . '/assets/js/vendor/jquery.cycle.all.js', array( 'jquery' ), JNEWS_MIGRATION_SAHIFA_VERSION );

			wp_enqueue_script( 'jnews-migration-sahifa-script', JNEWS_MIGRATION_SAHIFA_URL . '/assets/js/shortcode.js', array( 'jquery' ), JNEWS_MIGRATION_SAHIFA_VERSION );
			wp_localize_script( 'jnews-migration-sahifa-script', 'jnewsmigration', $this->migration_localize_script() );
		}
		...
		public function jeg_tabs( $atts, $content = null ) {
			...
			wp_enqueue_script( 'jnews-migration-sahifa-tabs' );
		...
		public function jeg_slideshow( $atts, $content = null ) {
			...
			wp_enqueue_script( 'jnews-migration-sahifa-cycle' );
                ...
                <div class="post-content-slideshow-outer">
                    <div id="post-slideshow-' . $this->unique_id . '" class="post-content-slideshow">
                        ...
                        <div class="post-tslideshow-nav-outer">
                            ...
                            <a class="next-' . $this->unique_id . ' post-slideshow-next" href="#"> ' . esc_html__( 'Next', 'jnews-migration-sahifa' ) . ' <i class="fa fa-angle-right"></i></a>
                            <a class="prev-' . $this->unique_id . ' post-slideshow-prev" href="#"><i class="fa fa-angle-left"></i> ' . esc_html__( 'Prev', 'jnews-migration-sahifa' ) . '</a>
                        </div>
                        ' . do_shortcode( $content ) . '
		...
		public function jeg_feed( $atts, $content = null ) {
			...
			if ( empty( $jeg_maxitems ) ) {
				$output = '<ul><li>' . esc_html__( 'No items.', 'jnews-migration-sahifa' ) . '</li></ul>';
			} else {
				$output = '<ul>';
