...
Plugin URI: http://wp-autopost.net
...
Version: 3.7.8
Author: WP-AutoPost.NET
Author URI: http://wp-autopost.net
*/
...
global  $wp_autopost_root,$table_prefix,$t_ap_config,$t_ap_config_option,$t_ap_config_url_list,$t_ap_updated_record,$t_ap_log,$t_autolink,$t_ap_more_content,$t_ap_flickr_img,$t_ap_flickr_oauth,$t_ap_qiniu_img,$t_ap_upyun_img,$t_ap_download_img_temp,$t_ap_watermark,$t_ap_config_group,$t_ap_proxy;
...
$t_ap_proxy = $table_prefix.'ap_proxy';
...
function wp_autopost_pro_install () {
  ...
  global $wpdb; $wp_autopost_db_version = '3.7.4';
  global $t_ap_config,$t_ap_config_option,$t_ap_config_url_list,$t_ap_updated_record,$t_ap_log,$t_autolink,$t_ap_more_content,$t_ap_flickr_img,$t_ap_flickr_oauth,$t_ap_qiniu_img,$t_ap_upyun_img,$t_ap_download_img_temp,$t_ap_watermark,$t_ap_config_group,$t_ap_proxy;
  ...
  if(($wpdb->get_var("SHOW TABLES LIKE '$t_ap_config'") != $t_ap_config)||$wp_autopost_db_version!=$old_db_version){
    ...
    content_match_type VARCHAR(1000) NOT NULL DEFAULT '0',
	...
	title_selector VARCHAR(1000) NULL DEFAULT NULL ,
	content_selector VARCHAR(4000) NULL DEFAULT NULL ,
	...
	img_insert_attachment CHAR(80) NULL DEFAULT NULL ,
	...
	proxy CHAR(20) NULL DEFAULT NULL ,
  ...
  //$t_ap_proxy
  if(($wpdb->get_var("SHOW TABLES LIKE '$t_ap_proxy'") != $t_ap_proxy)||$wp_autopost_db_version!=$old_db_version){
    $sql = "CREATE TABLE " . $t_ap_proxy . " (
	id SMALLINT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
	proxy_name VARCHAR(100) NOT NULL,
	proxy_type TINYINT(4) NOT NULL DEFAULT '0',
	proxy_ip VARCHAR(100) NOT NULL,
	proxy_port VARCHAR(100) NOT NULL,
	proxy_user VARCHAR(100) NOT NULL,
	proxy_pass VARCHAR(100) NOT NULL,
	PRIMARY KEY (id)
     ) COLLATE='utf8_unicode_ci' ENGINE=MyISAM";
