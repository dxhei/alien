...
if($saction=='changePerPage'){
   ...
   $wp_autopost_per_page['post'] = $_POST['postPerPage'];
...
$wp_autopost_per_page = get_option('wp_autopost_per_page');
if($wp_autopost_per_page['post']==null) $perPage=30;
else $perPage=$wp_autopost_per_page['post'];
...
<?php } ?>
 ...
 <div class="tablenav">
      <div class="actions alignleft">
        <?php echo  __('Number per page','wp-autopost'); ?> : <input type="text" name="postPerPage" value="<?php echo $perPage; ?>" size="5" onchange="changePerPage()"/>
	  </div>
