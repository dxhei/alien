...
function addNewGroup(){
  if(document.getElementById("new_group_name").value=='')return;
  document.getElementById("myform").submit();
}
function DeleteGroup(id){
  document.getElementById("group_id").value=id;
  document.getElementById("saction").value='DeleteGroup'; 
  document.getElementById("myform").submit();
}
function testFetch(){
...
function SaveOption1(save_to_group){
  document.getElementById("save_to_group6").value=save_to_group;
  document.getElementById("saction6").value='SaveOption1';
  document.getElementById("myform6").submit();
}
function SaveOption5(save_to_group){
  document.getElementById("save_to_group6").value=save_to_group;
  document.getElementById("saction6").value='SaveOption5';
  document.getElementById("myform6").submit();
}
function SaveOption2(save_to_group){
  document.getElementById("save_to_group7").value=save_to_group;
  document.getElementById("myform7").submit();
}
function SaveOption3(save_to_group){
  document.getElementById("save_to_group8").value=save_to_group;
  document.getElementById("myform8").submit();
}
function SaveOption4(save_to_group){
  document.getElementById("save_to_group9").value=save_to_group;
  document.getElementById("myform9").submit();
}
function SaveConfigOption(save_to_group){
  document.getElementById("save_to_group11").value=save_to_group;
  document.getElementById("myform11").submit();
}

function edit(save_to_group){
  if(document.getElementById("config_name").value==''){
	alert('Please Enter Task Name');  
    return;
  }
  document.getElementById("save_to_group").value=save_to_group;
  document.getElementById("myform1").submit();
}


function save2(save_to_group){
  ...
  document.getElementById("save_to_group2").value=save_to_group;
...
function save3(save_to_group){
  ...
  document.getElementById("save_to_group3").value=save_to_group;
...
function changePostType(){
  document.getElementById("saction18").value='changePostType';
  document.getElementById("myform18").submit(); 
}

function save15(save_to_group){
  document.getElementById("save_to_group15").value=save_to_group;
...
function save16(save_to_group){
  document.getElementById("save_to_group16").value=save_to_group;
  document.getElementById("myform16").submit();
}

function save17(save_to_group){
  document.getElementById("save_to_group17").value=save_to_group;
  document.getElementById("saction17").value='save17';
  document.getElementById("myform17").submit();
}

function save18(save_to_group){ 
  document.getElementById("save_to_group18").value=save_to_group;
  document.getElementById("myform18").submit();
}

function save19(save_to_group){
  document.getElementById("save_to_group19").value=save_to_group;
  document.getElementById("myform19").submit();
}

function save4(save_to_group){
  document.getElementById("save_to_group4").value=save_to_group;
  document.getElementById("myform4").submit();
}

function save5(save_to_group){
  document.getElementById("save_to_group5").value=save_to_group;
...
jQuery(document).ready(function($){    
	...
	$('#post_scheduled').change(function(){
		...
		if(sSwitch == 0){
		   ...
		   $("#post_scheduled1").val(0);
		   $("#published_interval").val(60);
		   $("#published_interval_1").val(60);
		   $("#published_interval").attr("disabled",false);
		}
	});

	$('#post_scheduled1').change(function(){
	    var sSwitch = $(this).val();
		if(sSwitch == 0){           
		   $("#published_interval").attr("disabled",false);
		   $("#published_interval").val(60);
           ...
           $("#post_scheduled_more").hide();
		   $("#post_scheduled").val(0);
		   $("#published_interval").val(0);
		   $("#published_interval").attr("disabled",true);
		}
	});
...
function SaveOption14(save_to_group){
  document.getElementById("save_to_group14").value=save_to_group;
...
function SaveOption6(save_to_group){
  document.getElementById("save_to_group10").value=save_to_group;
  document.getElementById("myform10").submit();
}


function save12(save_to_group){
  document.getElementById("save_to_group12").value=save_to_group;
  document.getElementById("saction12").value='SaveToGroup'; 
